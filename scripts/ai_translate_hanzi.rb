...
TEXTINPUT
    ...
    begin
      ...
      results << {
          ...
          "level": level, 
          "title": title,
          "slug":  level + "_" + CGI.escape(I18n.transliterate(title).downcase.gsub(/[^a-z0-9]+/, '-').gsub(/^-|-$/, ''))+"-"+SecureRandom.hex(4),
          "hanzi": hanzi_text, 
...
dictionary_file = '../_data/cedict_simplified.json' # Replace with your dictionary file
